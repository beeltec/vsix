use crate::domain::{DomainError, ExtensionRepository, InstallationRepository, SearchResult};
    ...
    pub async fn execute(
        ...
        if use_cursor {
            self.installation_repo
                .install_cursor(&vsix_data, &extension.unique_identifier())
                .await
        } else {
            self.installation_repo
                .install_vscode(&vsix_data, &extension.unique_identifier())
                .await
        }
    }
}
